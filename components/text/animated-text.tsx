...
function DefaultDemo() {
  return <AnimatedText text="Our  Events" />;
}
...
function SlowAnimationDemo() {
  return <AnimatedText text="Slower Animation" duration={0.8} delay={0.2} />;
}

export { DefaultDemo, CustomStyleDemo, HeadingDemo, SlowAnimationDemo };
